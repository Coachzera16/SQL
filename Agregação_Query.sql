-- PARA QUE SERVE ###############################################################
-- Servem para executar operaçãos aritiméticas nos registros de uma coluna
...
-- Conte todas as visitas realizadas ao site da empresa ficticia
SELECT  count(*)
FROM sales.funnel
...
-- (Exemplo 4) Calcule o preço minimo, máximo e médio dos productos da tabela products
select min (price), max(price), avg(price)
from sales.products

-- (Exemplo 5) Informe qual é o veiculo mais caro tabela products
...
-- RESUMO #########################################################################
-- (1) Servem para executar operaçãos aritimética nos registros de uma coluna
